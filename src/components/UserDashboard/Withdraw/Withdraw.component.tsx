		...
		<Container
			...
			<Card alignItems="left" pr={0} pl={0} w="75vw" textAlign="left">
				...
				<Text fontSize="13px" color="danger" ml="1.5rem">
					{'"'}Please note that you can only withdraw to the payment
					method.
					<br /> You are allowed to submit a withdrawal request once a
					time! The system will simply ignore the request if it does
